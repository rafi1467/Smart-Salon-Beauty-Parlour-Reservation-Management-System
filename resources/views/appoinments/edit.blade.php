    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden p-8 md:p-12">
                ...
                <form action="{{ route('appointments.update', $appointment->id) }}" method="POST" id="booking-form"
                    class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                            ...
                            <div class="mb-4">
                                <label
                                    class="block text-gray-500 text-xs uppercase tracking-wide font-bold mb-1">Service</label>
                                <p class="text-gray-900 font-bold text-lg">{{ $appointment->service->title }}</p>
                            </div>

                            <div class="mb-4">
                                <label class="block text-gray-600 text-sm font-bold mb-2">Change Stylist
                                    (Optional)</label>
                        ...
                        <div class="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                            ...
                            <div class="mb-4">
                                ...
                                <div id="slots-loading" class="hidden text-center py-4">
                                    <svg class="animate-spin h-6 w-6 text-purple-600 mx-auto"
                    ...
                    <div class="flex items-center justify-end mt-8 border-t border-gray-100 pt-6 space-x-4">
                        <a href="{{ route('appointments.index') }}"
                            class="text-gray-500 hover:text-gray-700 font-medium px-4">Cancel</a>
                        <button
                            class="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold py-3 px-8 rounded-xl shadow-lg transform transition hover:scale-105"
                            type="submit">
                            Confirm Reschedule
                        </button>
                    </div>
                        ...
                        try {
                            ...
                            if (data.slots && data.slots.length > 0) {
                                ...
                                data.slots.forEach(slot => {
                                    ...
                                    btn.className = `py-2 px-3 rounded-lg border text-sm font-medium transition ${isSelected
